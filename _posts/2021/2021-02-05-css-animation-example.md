...
[텍스트 그라데이션 animation](https://codepen.io/sxrdev/pen/LXMwPb)

-   IE don't support

[블랙 미러 깨지는 것](https://codepen.io/GeorgePark/pen/jeBbGN)

[같은 텍스트 여러개가 꼬리처럼 따라 다린다](https://codepen.io/mtsgeneroso/pen/mdJRpxX)

[185 TEXT-ANIMATION UI DESIGN EXAMPLES](https://codemyui.com/tag/text-animation/)
